...
public class GetAllUserDto
{
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getUser_role(), that.getUser_role()) &&
	...
	public int hashCode() {
		...
		return Objects.hash(getUser_role(), getUsername(), getFirst_name(), getLast_name(), getEmail(), getDeleted(), getEncrypted_password(), getAccount_state(), getRank(), getCourse_load(), getPhone_number(), getOffice(), getDepartment());
	}
