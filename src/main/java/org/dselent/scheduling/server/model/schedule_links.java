...
public class schedule_links
{
    ...
    static
    {
        for(schedule_links.Columns key: schedule_links.Columns.values())
        {
        ...
        COLUMN_TYPE_MAP.put(schedule_links.Columns.ID, JDBCType.INTEGER);
        COLUMN_TYPE_MAP.put(schedule_links.Columns.INSTRUCTOR_INFO_ID, JDBCType.INTEGER);
        COLUMN_TYPE_MAP.put(schedule_links.Columns.SECTION_INFO_ID, JDBCType.INTEGER);
    ...
    public static JDBCType getColumnType(schedule_links.Columns column)
    {
        return COLUMN_TYPE_MAP.get(column);
    }

    public static String getColumnName(schedule_links.Columns column)
    {
    ...
    public boolean equals(Object o) {
        ...
        schedule_links that = (schedule_links) o;
