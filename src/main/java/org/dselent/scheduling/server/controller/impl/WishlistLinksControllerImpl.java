...
public class WishlistLinksControllerImpl implements WishlistLinksController
{
	...
	public ResponseEntity<String> getWishlistLinks(@RequestBody Map<String, String> request) throws Exception 
    {
		...
		Integer InstructorInfoId = Integer.parseInt(GetWishlistLinks.getBodyName(GetWishlistLinks.BodyKey.INSTRUCTOR_INFO_ID));
		Integer sectionInfoId = Integer.parseInt(GetWishlistLinks.getBodyName(GetWishlistLinks.BodyKey.SECTION_INFO_ID));
