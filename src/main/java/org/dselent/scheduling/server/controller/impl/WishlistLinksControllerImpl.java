...
public class WishlistLinksControllerImpl implements WishlistLinksController
{
	...
	public ResponseEntity<String> getWishlistLinks(@RequestBody Map<String, String> request) throws Exception 
    {
		...
		String InstructorInfoId = request.get(GetWishlistLinks.getBodyName(GetWishlistLinks.BodyKey.INSTRUCTORINFOID));
		String sectionInfoId = request.get(GetWishlistLinks.getBodyName(GetWishlistLinks.BodyKey.SECTIONINFOID));
